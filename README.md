...
This project aims to build an entire supermarket-like system for a portfolio from scratch, starting with relational data modeling, SQL DDL creation, and SQL data loading. The exposition will be achieved via a REST API endpoint to interact with both a web app and a desktop app.
